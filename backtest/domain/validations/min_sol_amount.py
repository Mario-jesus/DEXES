# -*- coding: utf-8 -*-
"""
Validación de monto mínimo de SOL por exchange
"""
...
class MinSolAmountValidation(BaseValidation):
    """Validación de monto mínimo de SOL por exchange"""
    ...
    def __init__(self, 
        ...
        """
        Args:
            exchange_thresholds: Diccionario con umbrales por exchange
    ...
    def validate(self, transaction: SwapTransaction, context: Dict[str, Any]) -> ValidationResult:
        ...
        if transaction.side == 'sell':
            # Las ventas no se validan por monto mínimo
            return ValidationResult(
                is_valid=True,
                validation_name=self.name,
                message="Venta no requiere validación de monto mínimo"
            )
